...
app.get('/sobre', perfilAutorHandler);

app.listen(port, listenHandler);

function listProjectHandler(req, res){
    /* Os dados a seguir, em uma aplicação real, deveriam vir de um BD */
    let projeto_1 = new Projeto("Web","PHP", 2020, 2020, "https://github.com/cpusfatec/cpusfatec"); 
    let projeto_2 = new Projeto("Web","",2021,2021, "https://github.com/alira1984/CRUD");
    let projeto_3 = new Projeto("Web","Java", 2021, 2021, "https://github.com/cpusfatec/IONIC-Health-Project");    
    let projetos = [];
...
function perfilAutorHandler(req, res){
    res.render('perfil_autor.ejs')
}
